...
namespace AtoCash
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //"PostgreSQLConnectionString": "Server=sqldata;Port=5432;Database=AtoCashDB;User Id=sa;Password=Pa55word2019!123;Pooling=true;",


            //services.AddDbContextPool<AtoCashDbContext>(options => options.UseSqlServer(Configuration.GetConnectionString("PostgreSQLConnectionString")));

            services.AddDbContextPool<AtoCashDbContext>(options => options.UseNpgsql(Configuration.GetConnectionString("PostgreSQLConnectionString")));
